...
function makeSplash(x, type)
{
	...
	// Нарисуйте линию с помощью Snap SVG
	...
	// Мы анимируем dasharray, чтобы линия перемещалась по пути
	var pathLength = Snap.path.getTotalLength(splash);
	var xOffset = sizes.card.offset.left;//(sizes.container.width - sizes.card.width) / 2
	var yOffset = sizes.card.offset.top + sizes.card.height; 
    splash.node.style.strokeDasharray = splashLength + ' ' + pathLength;
	
	// Запустите анимацию всплеска, вызвав Splash Complete, когда закончите
